...
@endswitch 
 ...
 <tr><td class="active">Оплата в месяц:</td><td> {{ $user->tarif->cost }} руб.</td></tr>
 <tr><td class="active">Тарифный план:</td><td>{{ $user->tarif->name }} <a href="{{ route('tarifs_org')}}">( Сменить )</a></td></tr>
