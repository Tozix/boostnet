...
<div class="form-group">
    <!-- цена (руб) -->
    <input type="text" class="form-control w-25 d-inline mr-4" placeholder="Цена (руб.)" name="price" required
    ...
    <div class="form-check form-check-inline">
        ...
        @endphp
        <input type="checkbox" name="new" class="form-check-input" id="new-product" @if($checked) checked @endif
            value="1">
    ...
    <div class="form-check form-check-inline">
        ...
        @endphp
        <input type="checkbox" name="hit" class="form-check-input" id="hit-product" @if($checked) checked @endif
            value="1">
    ...
    <div class="form-check form-check-inline ">
        ...
        @endphp
        <input type="checkbox" name="sale" class="form-check-input" id="sale-product" @if($checked) checked @endif
            value="1">
...
<div class="form-group">
    ...
    <select name="category_id" class="form-control" title="Категория">
        ...
        @if(count($items))
        @include('admin.catalog.product.part.branch', ['level' => -1, 'parent' => 0])
        @endif
    </select>
</div>
<div class="form-group">
