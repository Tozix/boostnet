...
<h4> Добавить новый сервер</h4>
	...
	@endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="speed" type="text" class="form-control{{ $errors->has('speed') ? ' is-invalid' : '' }}" name="speed" value="{{ old('speed') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control" id="description" name="description" rows="3" required autofocus>{{ old('description') }}</textarea>
