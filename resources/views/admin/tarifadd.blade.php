...
<h4> Добавить новый тариф</h4>
	...
	@endif
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tarif_name" type="text" class="form-control{{ $errors->has('tarif_name') ? ' is-invalid' : '' }}" name="tarif_name" value="{{ old('tarif_name') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tarif_cost" type="text" class="form-control{{ $errors->has('tarif_cost') ? ' is-invalid' : '' }}" name="tarif_cost" value="{{ old('tarif_cost') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <select class="form-control" id="tarif_type" name="tarif_type">
                                    <option value="1" {{ old('tarif_type') == 1 ? 'selected' : '' }}>Тариф для физического лица</option>
                                    <option value="2" {{ old('tarif_type') == 2 ? 'selected' : '' }}>Тариф для юридического лица</option>
                              </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tarif_speed" type="text" class="form-control{{ $errors->has('tarif_speed') ? ' is-invalid' : '' }}" name="tarif_speed" value="{{ old('tarif_speed') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control" id="tarif_description" name="tarif_description" rows="3" required autofocus>{{ old('tarif_description') }}</textarea>
