...
<h4> Добавить организацию</h4>
	...
	@endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="org_email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="org_email" value="{{ old('org_email') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="org_tel" type="tel" class="form-control{{ $errors->has('org_tel') ? ' is-invalid' : '' }}" name="org_tel" value="{{ old('org_tel') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="org_inn" type="text" class="form-control{{ $errors->has('org_inn') ? ' is-invalid' : '' }}" name="org_inn" value="{{ old('org_inn') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="org_kpp" type="text" class="form-control{{ $errors->has('org_kpp') ? ' is-invalid' : '' }}" name="org_kpp" value="{{ old('org_kpp') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="org_bik" type="text" class="form-control{{ $errors->has('org_bik') ? ' is-invalid' : '' }}" name="org_bik" value="{{ old('org_bik') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="org_rschet" type="text" class="form-control{{ $errors->has('org_rschet') ? ' is-invalid' : '' }}" name="org_rschet" value="{{ old('org_rschet') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="org_korschet" type="text" class="form-control{{ $errors->has('org_korschet') ? ' is-invalid' : '' }}" name="org_korschet" value="{{ old('org_korschet') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="org_bank" type="text" class="form-control{{ $errors->has('org_bank') ? ' is-invalid' : '' }}" name="org_bank" value="{{ old('org_bank') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="org_dir_fio" type="text" class="form-control{{ $errors->has('org_dir_fio') ? ' is-invalid' : '' }}" name="org_dir_fio" value="{{ old('org_dir_fio') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="org_dir_dol" type="text" class="form-control{{ $errors->has('org_dir_dol') ? ' is-invalid' : '' }}" name="org_dir_dol" value="{{ old('org_dir_dol') }}" required autofocus >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address_ur" type="text" class="form-control{{ $errors->has('address_ur') ? ' is-invalid' : '' }}" name="address_ur" value="{{ old('address_ur') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="org_contacts" type="text" class="form-control" name="org_contacts" class="form-control {{ $errors->has('org_contacts') ? ' is-invalid' : '' }}" id="exampleTextarea" rows="3" required autofocus>{{ old('org_contacts') }}</textarea>
